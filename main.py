...
#llave para conexion a discord
llave="ODM1NjMzOTQ1NjUxNDQ1ODEw.YISSwQ.sH8BoYFGWhoBCBH4f-bhs142VRs"

#lectura archivo contenido 
with open("contenido.json", encoding='utf-8') as archivo:
    datos = json.load(archivo)
#lectura archivo variables
try:
